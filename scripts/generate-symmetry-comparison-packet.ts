...
import { createSymmetryCandidateFixture } from "@/entities/motion-grammar/model/symmetry-candidate-fixture";
import { buildSymmetryComparisonPacket } from "@/entities/motion-grammar/model/symmetry-comparison-packet";

const outputPath =
	process.argv[2] ?? "artifacts/symmetry-comparison-packet-20260716.json";
const fixture = createSymmetryCandidateFixture();
const packet = buildSymmetryComparisonPacket({
