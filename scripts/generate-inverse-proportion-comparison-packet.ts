...
import { createInverseProportionCandidateFixture } from "@/entities/motion-grammar/model/inverse-proportion-candidate-fixture";
import { buildInverseProportionComparisonPacket } from "@/entities/motion-grammar/model/inverse-proportion-comparison-packet";
import {
...
const outputPath =
	process.argv[2] ??
	"artifacts/inverse-proportion-comparison-packet-20260716.json";
const fixture = createInverseProportionCandidateFixture();
const packet = buildInverseProportionComparisonPacket({
	source: fixture.source,
	scene: fixture.scene,
	motion: fixture.motion,
	bindings: fixture.bindings,
	binding: fixture.binding,
	driverNodeId: fixture.driverNodeId,
	followerNodeId: fixture.followerNodeId,
