...
import { createInterferenceCandidateFixture } from "@/entities/motion-grammar/model/interference-candidate-fixture";
...
const outputPath =
	process.argv[2] ?? "artifacts/interference-comparison-packet-20260716.json";
const fixture = createInterferenceCandidateFixture();
const packet = buildInterferenceComparisonPacket({
	...
	ringNodeIds: fixture.ringNodeIds,
